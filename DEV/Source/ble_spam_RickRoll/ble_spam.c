...
// Slightly modified version of ble_spam by Marghost.  
// New "feature" that let's you Rick Roll people's Bluetooth settings.  
// Source available at https://github.com/marghost/Flipper-Project/blob/main/DEV/Source/ble_spam_RickRoll/
...
static Attack attacks[] = {
    {
        .title = "Spam BLE Settings",
        .text = "With Rick Roll Lyrics",
...
static void draw_callback(Canvas* canvas, void* _ctx) {
    ...
    canvas_draw_str(canvas, 14, 12, " Spicy BLE Spam");
    ...
    case PageAboutCredits:
        canvas_set_font(canvas, FontBatteryPercent);
        canvas_draw_str_aligned(canvas, 124, 12, AlignRight, AlignBottom, "V6.0");
        elements_text_box(
            canvas,
            4,
            16,
